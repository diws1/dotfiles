...
static const char *fonts[]          = { "Terminus (TTF):size=9", "Siji:size=10", "FontAwesome:size=8" };
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_bg, "-nf", col_fg, "-sb", col_bgs, "-sf", col_fgs, "-p", "Search:", NULL };
